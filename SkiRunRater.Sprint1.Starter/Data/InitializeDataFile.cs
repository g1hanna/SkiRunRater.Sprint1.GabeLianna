...
namespace SkiRunRater
{
    public class InitializeDataFile
    {
        ...
        public static void WriteAllSkiRuns(List<SkiRun> skiRuns, string dataFilePath)
        {
            ...
            //we can put var instead of SkiRun, because C# is a strongly-typed language and so you can 
            ...
            FileStream wfileStream = File.OpenWrite(dataFilePath); //same thing
            ...
            using (wfileStream)
            {
                ...
                //giving the StreamWriter access to the file using the FileStream (because wFileStream is an object of type FileStream with an input parameter of your data file path)
                ...
                // sWriter.Close();
                // we made this line of code redundant by putting sWriter inside the using block (using (sWriter))
            }
        }
    }
}
